...
export class Backend implements backendInterface {
    ...
    async createInvoice(arg0: Principal, arg1: Array<InvoiceItem>, arg2: InvoiceStatus): Promise<Invoice> {
        if (this.processError) {
            try {
                const result = await this.actor.createInvoice(arg0, arg1, to_candid_InvoiceStatus_n3(this._uploadFile, this._downloadFile, arg2));
    ...
    async deleteCustomer(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteInvoice(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteProduct(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateCustomer(arg0: Principal, arg1: string, arg2: string, arg3: string, arg4: string): Promise<Customer> {
        if (this.processError) {
            try {
    ...
    async updateInvoice(arg0: Principal, arg1: Principal, arg2: Array<InvoiceItem>, arg3: InvoiceStatus): Promise<Invoice> {
        if (this.processError) {
            try {
                const result = await this.actor.updateInvoice(arg0, arg1, arg2, to_candid_InvoiceStatus_n3(this._uploadFile, this._downloadFile, arg3));
                return from_candid_Invoice_n5(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
